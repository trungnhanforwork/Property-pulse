    ...
    const fetchPropertyData = async () => {
      try {
        ...
        if (propertyData && propertyData.rates) {
          const defaultPropertyRates = { ...propertyData.rates };
          for (const rate in defaultPropertyRates) {
            if (defaultPropertyRates[rate] === null) {
              defaultPropertyRates[rate] = "";
            }
          }
          propertyData.rates = defaultPropertyRates;
        }
        if (propertyData && propertyData.location) {
          const defaultPropertyLocation = {
            ...propertyData.location,
          };
          if (defaultPropertyLocation["zipcode"] === null) {
            defaultPropertyLocation["zipcode"] = "";
          }
          propertyData.location = defaultPropertyLocation;
        }
